...
_SERVICES = [
    ...
    ("ats.services.execution.strategy_trader", "StrategyTraderService"),
    ("ats.services.accounts.league", "LeagueService"),
    ("ats.services.execution.reconcile", "ReconciliationService"),
